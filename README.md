# Java Voting Simulation Project

## Project Overview
This project is a voting system simulation built using Java. It provides a simple interface for users to simulate voting processes. The application focuses on basic voting logic, candidate selection, and result display.
